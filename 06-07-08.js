...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      var nuevoarray = this.amigos.map(function(objeto){
    ...
    getHobbies() {
      ...
      // Tu código aca:
      var hobbiesPersona = this.hobbies.map(function(elemento) {
        return elemento;
      })
    ...
    getPromedioEdad() {
      ...
      var promedioEdad = this.amigos.reduce(function (acumulador , elemento) {
        return acumulador + elemento.edad;
      },0);
      return promedioEdad / cantidad;
    }
  };
